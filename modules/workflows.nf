include { VERTICALL_REPAIR; PREPARE_REPAIRED_FILES; VERTICALL_PAIRWISE; VERTICALL_MATRIX; VERTICALL_FASTME; VERTICALL_PAIRWISE_REF; VERTICALL_MASK } from '../modules/processes.nf' 
...
workflow ALIGNMENT {
    ...
    main:
        ...
        // VERTICALL_RAXMLNG(VERTICALL_MASK.out) // not implemented yet
